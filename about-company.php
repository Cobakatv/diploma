...
<body>
        ...
        <div class="header-info">
            <div class="container">
                <div class="header-local">
                    <a class="logo" href="index.html"><img src="/img/Header/LOGO.png" alt="LOGO"></a>
    ...
    <mail class="mail">
        <div class="container">
            ...
            <div class="content">
                <div class="contact-companu">
                    <div class="contact-block">
                        <h3 class="contact-title">О компани:</h3>
                        <p class="contact-text">
                        Компания <span class="">«Elwau»</span> уже более десяти лет поставляет игрушки оптом в магазины по всей территории Украины. Мы крупная и надежная компания с огромным опытом работы. Мы поставляем и продаем отличные игрушки.
                        Мы производим прямые закупки товара, а также имеем прочные давние связи с ведущими производителями Украины, Китая, Польши и Турции. Ассортимент нашей компании насчитывает более 10 000 наименований игрушек. Ежемесячно мы обновляем ассортимент – тысячи позиций самого актуального и востребованного на рынке товара.
                        Сфера деятельности нашей компании - оптовая торговля игрушками.
                        Оптовые клиенты для того, чтобы получить консультацию по ассортименту, обсудить условия сотрудничества, выбрать оптимальный для Вас способ доставки и сделать заказ, могут воспользоваться удобным для Вас способом связи.
                        Мы внимательно следим за всеми новинками и изменениями рынка и делаем все возможное, чтобы работа с нами приносила нашим клиентам максимальные успехи в их бизнесе.
                        </p>
                    </div>
                </div>
            </div>
